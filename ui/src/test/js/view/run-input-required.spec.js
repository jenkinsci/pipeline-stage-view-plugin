...
describe("view/run-input-required-spec", function () {
    var helper;
    var view;
    var inputModelData01;
    var inputModelData02;


    beforeEach(() => {
        helper = require('../helper');
        view = require('../../../main/js/view/run-input-required');

        inputModelData01 = helper.requireTestRes('view/run_input_required/input-model-01');
        inputModelData02 = helper.requireTestRes('view/run_input_required/input-model-02');
    });
    ...
    it("- test_abort", function (done) {
        ...
        helper.testWithJQuery(pageFrame, function ($) {
            ...
            var ajax = require('../../../main/js/util/ajax')
